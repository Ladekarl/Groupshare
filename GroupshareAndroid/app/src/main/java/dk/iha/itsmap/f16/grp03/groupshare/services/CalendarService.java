...
import dk.iha.itsmap.f16.grp03.groupshare.models.CalendarEvent;
import dk.iha.itsmap.f16.grp03.groupshare.models.GroupShareCalendar;

public class CalendarService extends IntentService {
    private static final String ACTION_GET_CALENDAR = "CalendarService.action.getCalendar";
    private static final String ACTION_SAVE_CALENDAR = "CalendarService.action.saveCalendar";
    private static final String ACTION_DELETE_CALENDAR = "CalendarService.action.deleteCalendar";
    private static final String ACTION_DELETE_CALENDAR_EVENT = "CalendarService.action.deleteCalendarEvent";
    public static final String EXTRA_CALENDAR = "CalendarService.extra.GroupShareCalendar";
    public static final String EXTRA_GROUP_ID = "CalendarService.extra.GroupId";
    public static final String EXTRA_USER_ID = "CalendarService.extra.userId";
    public static final String EXTRA_CALENDAR_ID = "CalendarService.extra.calendarId";
    public static final String GET_CALENDAR_BROADCAST_INTENT = "CalendarService.intent.getCalendar";
    public static final String DELETE_CALENDAR_EVENT_BROADCAST_INTENT = "CalendarService.intent.deleteCalendarEvent";
    private static final String CALENDAR_SHARED_PREFERENCES = "CalendarService.sharedPref";
    private static final String EXTRA_CALENDAR_EVENT_ID = "CalendarService.extra.calendarEventId";
