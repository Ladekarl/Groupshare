...
public class GroupService extends IntentService {
    ...
    public static final String EXTRA_GROUP_ID = "group03.itsmap.groupshare.services.GroupService.extra.GroupId";
    public static final String GET_GROUPS_BROADCAST_INTENT = "group03.itsmap.groupshare.services.GroupService.intent.getGroups";
    public static final String GET_SINGLE_GROUP_BROADCAST_INTENT = "group03.itsmap.groupshare.services.GroupService.intent.getGroup";
